...
public class ParserCapas extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\002\000\002\005\005\000\002\006\004\000\002\006\003" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\010\002\010\004\005\005\006\001\002\000\004\006\ufffa" +
    "\001\002\000\004\006\ufff9\001\002\000\004\006\012\001" +
    "\002\000\004\002\001\001\002\000\010\002\000\004\000" +
    "\005\000\001\002\000\004\005\013\001\002\000\004\011" +
    "\020\001\002\000\006\005\013\007\017\001\002\000\006" +
    "\005\ufffc\007\ufffc\001\002\000\006\005\ufffd\007\ufffd\001" +
    "\002\000\010\002\ufffe\004\ufffe\005\ufffe\001\002\000\004" +
    "\005\021\001\002\000\004\011\022\001\002\000\004\012" +
    "\023\001\002\000\004\010\024\001\002\000\006\005\ufffb" +
    "\007\ufffb\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\022\000\004\002\003\001\001\000\004\003\006\001" +
    "\001\000\002\001\001\000\002\001\001\000\004\005\010" +
    "\001\001\000\002\001\001\000\002\001\001\000\006\006" +
    "\013\007\014\001\001\000\002\001\001\000\004\007\015" +
  ...
  public final java_cup.runtime.Symbol CUP$ParserCapas$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ParserCapas$act_num)
		...
		int datos_Obtenidosleft = ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.elementAt(CUP$ParserCapas$top-1)).left;
		int datos_Obtenidosright = ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.elementAt(CUP$ParserCapas$top-1)).right;
		MatrizDispersa datos_Obtenidos = (MatrizDispersa)((java_cup.runtime.Symbol) CUP$ParserCapas$stack.elementAt(CUP$ParserCapas$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // datos ::= datos datos_opciones 
            {
              MatrizDispersa RESULT =null;
		...
		int tokenMleft = ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.peek()).left;
		int tokenMright = ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.peek()).right;
		TokenMatrizDispersa tokenM = (TokenMatrizDispersa)((java_cup.runtime.Symbol) CUP$ParserCapas$stack.peek()).value;
		...
		MatrizDispersa matriz = new MatrizDispersa();
              ...
              CUP$ParserCapas$result = parser.getSymbolFactory().newSymbol("datos",4, ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.peek()), ((java_cup.runtime.Symbol)CUP$ParserCapas$stack.peek()), RESULT);
            }
          return CUP$ParserCapas$result;
          ...
          case 6: // datos_opciones ::= NUMERO COMA NUMERO COMA COLOR PUNTO_COMA 
            {
              TokenMatrizDispersa RESULT =null;
    ...
    RESULT = new TokenMatrizDispersa(Integer.parseInt(fila.toString()), Integer.parseInt(columna.toString()), color.toString());
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // identificador ::= HEXADECIMAL 
            {
              Object RESULT =null;
